export default () => {
  return new Promise(function(resolve) {
    resolve({
      ...
      webinarspotLanding: {
        header_home: 'home',
        header_feature: 'fitur utama',
        header_popular: 'kursus populer',
        ...
        header_dark: 'dark',
        header_light: 'light',
        banner_title: 'Tingkatkan Diri Anda',
        banner_desc:
          'Di mana saja, kapan saja. Mulai belajar hari ini! Dan Dapatkan Pengalaman Pendidikan yang Luar Biasa.',
        banner_search: 'Kursus pencarian ...',
        feature_title: 'Fitur Utama',
        feature_desc: 'Pilihan kursus terbesar di dunia',
        counter_videos: 'Video HD',
        counter_mentors: 'Mentor Profesional',
        counter_save: 'Hemat per Bulan',
        counter_free: 'Akses Seumur Hidup',
        popular_title: 'Kursus Populer',
        popular_desc:
          'Pilih dari banyak pilihan kursus populer dengan harga terobosan.',
        explore_title: 'Jelajahi Kursus',
        explore_desc:
          'Pilih dari 100.000 kursus video online dengan tambahan baru yang diterbitkan setiap bulan.',
        about_title: 'Tentang kami',
        about_desc:
          'Misi kami adalah untuk mendiversifikasi industri teknologi melalui pendidikan dan pemagangan yang dapat diakses, membuka pintu menuju peluang dan memberdayakan orang untuk mencapai impian mereka.',
        about_join: 'Bergabung Sekarang',
        testimonials_title: 'Testimonials',
        testimonials_desc: 'Mereka Melakukan Hal Hebat Bersama Kami',
        blog_title: 'Apa pembaruan?',
        blog_desc:
          'Berita terkini, berita terbaru, video, audio dan cerita fitur',
        blog_video: 'Desain Interior Rumah - Tur Video',
        subscribe_title: 'Tetap berkomunikasi',
        subscribe_subtitle:
          'Berlangganan newsletter kami dan dapatkan informasi terbaru tentang perkembangan terkini dan penawaran khusus!',
        subscribe_input: 'Masukkan alamat email Anda',
        subscribe_subscribe: 'Berlangganan'
      }
    })
  })
}
